...
/*:
 ----
 이번 챕터에서는 클래스에 대하여 알아보았습니다.
 이 전 챕터인 구조체와 클래스는 개발을 진행하면서 정말 많이 사용하는 부분들입니다.
 개발을 진행하시면서 자주 사용하시다보면 손에 착착 감기는 날이 있을 것 이라고 생각합니다.
 다음 챕터에서는 의미가 있는 값들을 열거하여 사용할 수 있는 `Enum`에 대하여 알아보도록 하겠습니다.
